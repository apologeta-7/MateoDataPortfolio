...
Data Analyst with 9+ years of international experience in operations, forecasting, and team management. Completed a Master's in Data Science & AI at Nuclio Digital School (2026), with a focus on building production-ready, business-oriented analytics solutions.
...
### 🏪 DSMarket — Demand Forecasting & Stock Replenishment
*TFM · Nuclio Digital School 2026*
...
📁 [View project →](https://github.com/apologeta-7/DSMarket)

---

### 🔒 Malware Risk Prediction
*MSc project · Nuclio Digital School — grade: 8.5/10*
...
📁 [View project →](https://github.com/apologeta-7/MateoDataPortfolio)
...
📁 [View project →](https://github.com/apologeta-7/MateoDataPortfolio/tree/main/santander)
...
📁 [View project →](https://github.com/apologeta-7/MateoDataPortfolio/tree/main/house_price_kaggle)
...
Classic binary classification with emphasis on pipeline structure and model comparison rather than novelty. Includes Title extraction, FamilySize, IsAlone features. Multiple models compared with focus on fairness and minority-class recall.

**Tech:** Python · scikit-learn · XGBoost · Pandas  
**Results:** Best accuracy 0.8101 (Logistic Regression) · Best survivor recall: Balanced Random Forest

📁 [View project →](https://github.com/apologeta-7/MateoDataPortfolio/tree/main/titanic-survival-prediction)
...
MSc Data Science & AI — Nuclio Digital School (2026)  
